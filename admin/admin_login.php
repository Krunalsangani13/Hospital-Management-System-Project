	...
	<head>
		...
		<form method="POST">
			...
			<div class="col-sm-4 offset-4 divup">
				...
				<br>
				<h2 class="text-center text-dark font-bold text-capitalize"> welcome admin</h2>
				<br><br>
					<div class="container text-center">
						...
						<br><br><br>
						<p>Don't Have an Account? &nbsp;<a href="admin_ragistration.php" class="text-dark font-weight-bold">Sing Up</a></p>
						<br><br><br>
					</div>
				</div>
			</div>
...
<?php
	if(isset($_POST["submit"]))
	{
		...
		$query=mysqli_query($con,"select * from admin_registration where a_e_mail='$email' AND a_password='$password'");
